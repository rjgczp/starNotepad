  ...
  <div>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="starNodeCore_UserInfo" />
            <ExportExcel  template-id="starNodeCore_UserInfo" filterDeleted/>
            <ImportExcel  template-id="starNodeCore_UserInfo" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column align="left" label="唯一标识" prop="id" width="120" />

            <el-table-column sortable align="left" label="账号" prop="username" width="120" />

            <el-table-column align="left" label="联系方式" prop="emailPhone" width="120" />
    ...
    <template #default="scope">
      <el-image preview-teleported style="width: 100px; height: 100px" :src="getUrl(scope.row.avatar)" fit="cover"/>
            ...
            <el-table-column align="left" label="签名" prop="signature" width="120" />

        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            <template #default="scope">
            <el-button  type="primary" link class="table-button" @click="getDetails(scope.row)"><el-icon style="margin-right: 5px"><InfoFilled /></el-icon>查看</el-button>
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateUserInfoFunc(scope.row)">编辑</el-button>
    ...
    <el-input v-model="formData.username" :clearable="false" placeholder="请输入账号" />
</el-form-item>
            <el-form-item label="密码:" prop="password">
    <el-input v-model="formData.password" :clearable="false" placeholder="请输入密码" />
</el-form-item>
            <el-form-item label="联系方式:" prop="emailPhone">
    <el-input v-model="formData.emailPhone" :clearable="false" placeholder="请输入联系方式" />
</el-form-item>
    ...
    <el-input v-model="formData.address" :clearable="false" placeholder="请输入住址" />
</el-form-item>
...
import {
  ...
  findUserInfo,
  getUserInfoList
} from '@/api/starNodeCore/userModel'
...
const getTableData = async() => {
  const table = await getUserInfoList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
