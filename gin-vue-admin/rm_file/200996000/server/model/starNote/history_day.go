...
type HistoryDay struct {
	...
	Title    *string `json:"title" form:"title" gorm:"comment:事件简短标题;column:title;" binding:"required"`                                                 //标题
	Summary  *string `json:"summary" form:"summary" gorm:"comment:短评;column:summary;"`                                                                  //短评
	...
	Type     string  `json:"type" form:"type" gorm:"comment:分类 (1:政治, 2:科技, 3:文化, 4:星记事专属);column:type;type:enum('1','2','3','4');" binding:"required"` //分类
