...
function dynamicImport(dynamicViewsModules, component) {
  // Explicitly retain independently added management pages when a development
  // server was already running before Vite refreshed its glob import list.
  if (component === 'view/duoCall/duoCall.vue') {
    return () => import('../view/duoCall/duoCall.vue')
  }
