  ...
  <div>
        ...
        >
          <template #default="scope">
            <div v-if="scope.row.meta.icon" class="icon-column">
              <i :class="normalizeIconfontClass(scope.row.meta.icon)" />
    ...
    >
      ...
      <div class="mb-2 mt-2">
        ...
        <el-table :data="form.menuBtn || []" border size="small" class="w-full">
          ...
          <el-table-column align="center" prop="desc" label="按钮描述">
            <template #default="scope">
              <el-input
