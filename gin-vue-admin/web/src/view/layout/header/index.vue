          ...
          <el-dropdown-menu>
            ...
            <el-dropdown-item @click="toPerson">
              <span class="dropdown-action-item">
                <i :class="normalizeIconfontClass('wode')" />
                <span>个人信息</span>
              </span>
            </el-dropdown-item>
            <el-dropdown-item @click="userStore.LoginOut">
              <span class="dropdown-action-item">
                <i :class="normalizeIconfontClass('sign-out')" />
                <span>登 出</span>
              </span>
            </el-dropdown-item>
          </el-dropdown-menu>
...
<script setup>
  ...
  const toPerson = () => {
    if (!router.hasRoute('person') && router.hasRoute('layout')) {
    ...
    router.push(router.hasRoute('person') ? { name: 'person' } : { path: '/layout/person' })
  }
