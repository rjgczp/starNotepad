  ...
  <el-input v-model="searchInfo.content" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column align="left" label="标题" prop="title" min-width="260" show-overflow-tooltip />
    ...
    <el-input v-model="formData.summary" type="textarea" :autosize="{ minRows: 2, maxRows: 6 }" :clearable="false" placeholder="请输入短评" />
</el-form-item>
            <el-form-item label="内容:" prop="content">
    <RichEdit v-model="formData.content"/>
</el-form-item>
            <el-form-item label="名言:" prop="quote">
    <el-input v-model="formData.quote" type="textarea" :autosize="{ minRows: 2, maxRows: 6 }" :clearable="false" placeholder="请输入名言" />
</el-form-item>
