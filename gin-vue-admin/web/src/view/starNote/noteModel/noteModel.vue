  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column align="left" label="所属用户" prop="userName" width="120">
              <template #default="scope">
                {{ scope.row.userName || scope.row.userID }}
              </template>
            </el-table-column>

            <el-table-column align="left" label="分类" prop="categoryID" width="160">
              <template #default="scope">
   ...
   <template #default="scope">{{ formatDate(scope.row.recordedAt) }}</template>
    ...
    {{ detailForm.userName || detailForm.userID }}
    ...
    <div class="flex items-center gap-2">
      ...
      <span>{{ detailForm.color }}</span>
                    ...
                    <el-descriptions-item label="图标">
                      <div class="flex items-center gap-2">
                        <i v-if="detailForm.icon" :class="detailForm.icon" class="text-lg" />
...
const setOptions = async () => {
  ...
  if (res.code === 0) {
    ...
    const m = {}
    categoryOptions.value.forEach((it) => {
      m[it.ID] = it.name
    })
...
const getCategoryName = (categoryID) => {
  return categoryNameMap.value?.[categoryID] || categoryID
}
