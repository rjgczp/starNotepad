...
<script setup>
  ...
  const primaryColor = computed(() => config.value?.primaryColor || '#194bfb')
  defineProps({
    height: {
      type: String,
      default: '128px'
      ...
      series: [
        {
          ...
          lineStyle: {
            ...
            color: new graphic.LinearGradient(0, 0, 1, 0, [
              {
                offset: 0,
                color: `${primaryColor.value}80`
              },
              {
                offset: 0.5,
                color: `${primaryColor.value}92`
              },
              {
                offset: 1,
                color: `${primaryColor.value}FF`
          ...
          areaStyle: {
            ...
            color: new graphic.LinearGradient(0, 0, 0, 1, [
              {
                offset: 0,
                color: `${primaryColor.value}20`
              },
              {
                offset: 1,
                color: `${primaryColor.value}08`
              }
            ])
          }
        }
