...
// @Tags     Base
// @Summary  根据用户名和旧密码重置密码
// @Produce  application/json
// @Param    data  body      systemReq.ResetPasswordByUsernameReq  true  "用户名, 旧密码, 新密码"
// @Success  200   {object}  response.Response{msg=string}         "重置成功"
// @Router   /base/resetPasswordByUsername [post]
func (b *BaseApi) ResetPasswordByUsername(c *gin.Context) {
	var req systemReq.ResetPasswordByUsernameReq
	...
	if err := userService.ResetPasswordByUsername(req.Username, req.OldPassword, req.NewPassword); err != nil {
