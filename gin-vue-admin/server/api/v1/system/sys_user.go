...
// @Tags     Base
// @Summary  根据用户名重置密码(简化版)
// @Produce  application/json
// @Param    data  body      systemReq.ResetPasswordByUsernameReq  true  "用户名, 新密码"
...
func (b *BaseApi) ResetPasswordByUsername(c *gin.Context) {
	...
	if err := userService.ResetPasswordByUsername(req.Username, req.NewPassword); err != nil {
