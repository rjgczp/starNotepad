...
func initBizRouter(routers ...*gin.RouterGroup) {
	...
	}
	{
		...
		systemRouter.InitMainImageRouter(privateGroup, publicGroup)
		systemRouter.InitBlogContentRouter(privateGroup, publicGroup)
		systemRouter.InitDuoCallRouter(privateGroup, publicGroup)
	}
	{
