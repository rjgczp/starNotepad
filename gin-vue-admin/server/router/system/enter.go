...
var (
	...
	bcApi               = api.ApiGroupApp.SystemApiGroup.UserBlog_configApi
	mainImageApi        = api.ApiGroupApp.SystemApiGroup.MainImageApi
	blogContentApi      = api.ApiGroupApp.SystemApiGroup.BlogContentApi
	duoCallApi          = api.ApiGroupApp.SystemApiGroup.DuoCallApi
)
