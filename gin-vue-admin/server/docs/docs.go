...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/starNote.NoteModel"
                        }
                    }
                ],
                "responses": {
        ...
        "/hd/createHistoryDay": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建历史上的今天",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/starNote.HistoryDay"
                        }
                    }
                ],
                "responses": {
        ...
        "/nc/createNoteCategory": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建记事本分类管理",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/starNote.NoteCategory"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/starNote.StarColor"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/starNote.StarTag"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/starNote.UserAccount"
                        }
                    }
                ],
                "responses": {
        ...
        "/ua/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "用户名/邮箱/手机 + 密码",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UserAccountLogin"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "返回token与用户信息",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UserAccountRegister"
                        }
                    }
                ],
                "responses": {
        ...
        "/ufile/download/{filepath}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "文件路径(如 uploads/file/xxx.png)",
                        "name": "filepath",
                        "in": "path",
                        "required": true
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UserStarColorCreateReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UserStarColorUpdateReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_flipped-aurora_gin-vue-admin_server_model_system_request.ChangePasswordReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_flipped-aurora_gin-vue-admin_server_model_system_request.ChangePasswordReq": {
            "type": "object",
            "properties": {
                "newPassword": {
                    "description": "新密码",
        ...
        "request.UserStarColorCreateReq": {
            "type": "object",
            "required": [
                "color",
                "name"
        ...
        "request.UserStarColorUpdateReq": {
            "type": "object",
            "required": [
                "color",
                "id",
