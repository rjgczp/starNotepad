...
func (ua *UserAccount) GetUsername() string {
	if ua == nil || ua.Username == nil {
		return ""
	}
	return *ua.Username
}

func (ua *UserAccount) GetNickname() string {
	if ua == nil || ua.Nickname == nil {
		return ""
	}
	return *ua.Nickname
}

func (ua *UserAccount) GetUUID() uuid.UUID {
	return uuid.UUID{}
}

func (ua *UserAccount) GetUserId() uint {
	if ua == nil {
		return 0
	}
	return ua.ID
...
func (ua *UserAccount) GetAuthorityId() uint {
	return 0
}

func (ua *UserAccount) GetUserInfo() any {
	if ua == nil {
		return nil
	}
	return *ua
